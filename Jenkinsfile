node {
  ...
  stage ('Deploy'){
    sh "aws s3 cp /var/jenkins_home/workspace/java-pipeline/dist/rectangle-${env.BUILD_NUMBER}.jar s3://assignment10-s3bucket-o6pl7q0lmjh9.s3.amazonaws.com/index.html"
  }
  stage ('Report'){
